# This Makefile is for the Template::Plugin::Filter::HTMLScrubber extension to perl.
#
...
#     ABSTRACT => q[TT Filter using HTML::Scrubber]
#     AUTHOR => q[Yu Isobe <yupug@cpan.org>]
#     DIR => []
#     DISTNAME => q[Template-Plugin-Filter-HTMLScrubber]
#     NAME => q[Template::Plugin::Filter::HTMLScrubber]
#     NO_META => q[1]
#     PL_FILES => {  }
...
FULLEXT = Template/Plugin/Filter/HTMLScrubber
BASEEXT = HTMLScrubber
PARENT_NAME = Template::Plugin::Filter
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Template/Plugin/Filter/HTMLScrubber.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Template/Plugin/Filter
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Template/Plugin/Filter
...
TO_INST_PM = lib/Template/Plugin/Filter/HTMLScrubber.pm

PM_TO_BLIB = lib/Template/Plugin/Filter/HTMLScrubber.pm \
...
manifypods : pure_all  \
	lib/Template/Plugin/Filter/HTMLScrubber.pm \
	lib/Template/Plugin/Filter/HTMLScrubber.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Template/Plugin/Filter/HTMLScrubber.pm $(INST_MAN3DIR)/Template::Plugin::Filter::HTMLScrubber.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00.load.t t/01.use-plugin-with-tt.t t/02.use-plugin-expand.t t/perlcritic.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Template-Plugin-Filter" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Template/Plugin/Filter/HTMLScrubber.pm blib/lib/Template/Plugin/Filter/HTMLScrubber.pm 
